...
`,[I("icon",`
 ...
 width: .6em;
 max-width: .6em;
 `,[Ye({duration:".2s"}),ne({duration:".2s",delay:"0s"}),h("base-slot-machine-old-number",`
 display: inline-block;
 opacity: 0;
 position: absolute;
 left: 0;
 right: 0;
 `,[E("top",{transform:"translateY(-100%)"}),E("bottom",{transform:"translateY(100%)"}),E("down-scroll",{animation:"n-base-slot-machine-fade-down-out .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),E("up-scroll",{animation:"n-base-slot-machine-fade-up-out .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1})]),h("base-slot-machine-current-number",`
 display: inline-block;
 position: absolute;
 left: 0;
 top: 0;
 ...
 transform: translateY(0);
 width: .6em;
 `,[E("down-scroll",{animation:"n-base-slot-machine-fade-down-in .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),E("up-scroll",{animation:"n-base-slot-machine-fade-up-in .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),I("inner",`
 display: inline-block;
 position: absolute;
 right: 0;
 top: 0;
 ...
 right: unset;
 left: 0;
 `)])])])])]),Ue=B({name:"BaseSlotMachine",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],default:0},max:{type:Number,default:void 0},appeared:{type:Boolean,required:!0}},setup(e){te("-base-slot-machine",He,D(e,"clsPrefix"));const s=R(),n=R(),u=v(()=>{if(typeof e.value=="string")return[];if(e.value<1)return[0];const l=[];let t=e.value;for(e.max!==void 0&&(t=Math.min(e.max,t));t>=1;)l.push(t%10),t/=10,t=Math.floor(t);return l.reverse(),l});return q(D(e,"value"),(l,t)=>{typeof l=="string"?(n.value=void 0,s.value=void 0):typeof t=="string"?(n.value=l,s.value=void 0):(n.value=l,s.value=t)}),()=>{const{value:l,clsPrefix:t}=e;return typeof l=="number"?d("span",{class:`${t}-base-slot-machine`},d(se,{name:"fade-up-width-expand-transition",tag:"span"},{default:()=>u.value.map((r,f)=>d(G,{clsPrefix:t,key:u.value.length-f-1,oldOriginalNumber:s.value,newOriginalNumber:n.value,value:r}))}),d(oe,{key:"+",width:!0},{default:()=>e.max!==void 0&&e.max<l?d(G,{clsPrefix:t,value:"+"}):null})):d("span",{class:`${t}-base-slot-machine`},l)}}}),We=e=>{const{errorColor:s,infoColor:n,successColor:u,warningColor:l,fontFamily:t}=e;return{color:s,colorInfo:n,colorSuccess:u,colorError:s,colorWarning:l,fontSize:"12px",fontFamily:t}},je={name:"Badge",common:M,self:We},Fe=je,Xe=g([g("@keyframes badge-wave-spread",{from:{boxShadow:"0 0 0.5px 0px var(--n-ripple-color)",opacity:.6},to:{boxShadow:"0 0 0.5px 4.5px var(--n-ripple-color)",opacity:0}}),h("badge",`
 display: inline-flex;
 position: relative;
 vertical-align: middle;
 color: var(--n-color);
 font-family: var(--n-font-family);
 `,[E("as-is",[h("badge-sup",{position:"static",transform:"translateX(0)"},[j({transformOrigin:"left bottom",originalTransform:"translateX(0)"})])]),E("dot",[h("badge-sup",`
 height: 8px;
 width: 8px;
 padding: 0;
 min-width: 8px;
 ...
 `)])]),en={small:20,medium:18,large:16},nn=Object.assign(Object.assign({},O.props),{description:String,stroke:String,size:{type:[String,Number],default:"medium"},show:{type:Boolean,default:!0},strokeWidth:Number,rotate:{type:Boolean,default:!0},spinning:{type:Boolean,validator:()=>!0,default:void 0}}),tn=B({name:"Spin",props:nn,setup(e){const{mergedClsPrefixRef:s,inlineThemeDisabled:n}=Y(e),u=O("Spin","-spin",Je,Qe,e,s),l=v(()=>{const{size:r}=e,{common:{cubicBezierEaseInOut:f},self:m}=u.value,{opacitySpinning:p,color:i,textColor:c}=m,b=typeof r=="number"?me(r):m[P("size",r)];return{"--n-bezier":f,"--n-opacity-spinning":p,"--n-size":b,"--n-color":i,"--n-text-color":c}}),t=n?H("spin",v(()=>{const{size:r}=e;return typeof r=="number"?String(r):r[0]}),l,e):void 0;return{mergedClsPrefix:s,compitableShow:fe(e,["spinning","show"]),mergedStrokeWidth:v(()=>{const{strokeWidth:r}=e;if(r!==void 0)return r;const{size:f}=e;return en[typeof f=="number"?"medium":f]}),cssVars:n?void 0:l,themeClass:t==null?void 0:t.themeClass,onRender:t==null?void 0:t.onRender}},render(){var e,s;const{$slots:n,mergedClsPrefix:u,description:l}=this,t=n.icon&&this.rotate,r=(l||n.description)&&d("div",{class:`${u}-spin-description`},l||((e=n.description)===null||e===void 0?void 0:e.call(n))),f=n.icon?d("div",{class:[`${u}-spin-body`,this.themeClass]},d("div",{class:[`${u}-spin`,t&&`${u}-spin--rotate`],style:n.default?"":this.cssVars},n.icon()),r):d("div",{class:[`${u}-spin-body`,this.themeClass]},d(pe,{clsPrefix:u,style:n.default?"":this.cssVars,stroke:this.stroke,"stroke-width":this.mergedStrokeWidth,class:`${u}-spin`}),r);return(s=this.onRender)===null||s===void 0||s.call(this),n.default?d("div",{class:[`${u}-spin-container`,this.themeClass],style:this.cssVars},d("div",{class:[`${u}-spin-content`,this.compitableShow&&`${u}-spin-content--spinning`]},n),d(Z,{name:"fade-in-transition"},{default:()=>this.compitableShow?f:null})):f}});const on=B({components:{NLayoutFooter:be,NGrid:he,NGi:ve,NCard:ye,NButton:xe,NImage:Ne,NBadge:qe,NIcon:Ce,NSpace:Be,NText:_e,NEmpty:Me,NSpin:tn},setup(){const e=we(),s=Se(),n=ze();return{isMobile:e,isTablet:s,isSmallDesktop:n,storeConnect:Ee}}}),sn={class:"main-content",style:{"overflow-y":"auto",padding:"12px"}},an=C("h1",null,"UPGRADE",-1),rn=C("p",null,"PLEASE CONNECT WALLET",-1),ln=C("p",null,"YOU WILL NEED TWO THINGS:",-1),cn={key:1,style:{"text-align":"center"}},dn={class:"footer-center"},un={class:"footer-center"},mn=C("svg",{version:"1.1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",x:"0px",y:"0px",viewBox:"0 0 512 512","enable-background":"new 0 0 512 512","xml:space":"preserve"},[C("g",null,[C("g",null,[C("path",{d:"M416,277.333H277.333V416h-42.666V277.333H96v-42.666h138.667V96h42.666v138.667H416V277.333z"})])])],-1),fn=C("svg",{version:"1.1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",x:"0px",y:"0px",viewBox:"0 0 512 512","enable-background":"new 0 0 512 512","xml:space":"preserve"},[C("rect",{x:"96",y:"235",width:"320",height:"42"})],-1);function pn(e,s,n,u,l,t){const r=w("n-card"),f=w("n-image"),m=w("n-gi"),p=w("n-button"),i=w("n-space"),c=w("n-grid"),b=w("n-text"),A=w("n-badge"),_=w("n-spin"),y=w("n-empty"),x=w("n-layout-footer"),L=w("n-icon");return $(),V(F,null,[C("div",sn,[e.storeConnect.selectedAccount?e.storeConnect.valueUpgrades.length>0?($(),N(r,{key:1,class:"content-card"},{default:o(()=>[a(c,{class:"grid-center","x-gap":0,"y-gap":12,cols:"8 xs:3 s:3 m:8 l:8",responsive:"screen",style:{"align-items":"center"}},{default:o(()=>[a(m,{span:"4 xs:8 m:4"},{default:o(()=>[C("p",null,[a(b,{strong:""},{default:o(()=>[z("UPGRADABLE BOXES IN YOUR WALLET")]),_:1})])]),_:1}),a(m,{span:"2 xs:0 m:2"}),a(m,{span:"2 xs:8 m:2"},{default:o(()=>[a(p,{block:"",type:"info",class:"button-info",onClick:e.storeConnect.upgradeAutoSelect,disabled:e.storeConnect.upgradeTxSending},{default:o(()=>[z("AUTO SELECT")]),_:1},8,["onClick","disabled"])]),_:1}),a(m,{span:"0 xs:8"})]),_:1}),e.storeConnect.upgradeTxSending?($(),V("p",cn,[a(_,{size:"large"})])):($(),N(c,{key:0,id:"image-scroll-container",class:"grid-center","x-gap":30,"y-gap":30,cols:"5 xs:2 s:3 m:4 l:5",responsive:"screen",style:{"align-items":"center"}},{default:o(()=>[($(!0),V(F,null,ke(e.storeConnect.rangeUpdateBoxes,(S,k)=>($(),N(m,{key:S,style:{"text-align":"center"}},{default:o(()=>[a(r,{class:"box-select-to-upgrade",bordered:e.storeConnect.selectBordered[k],onClick:U=>e.storeConnect.selectBoxToUpgrade(S,k)},{cover:o(()=>[a(A,{value:e.storeConnect.valueUpgrades[k]},{default:o(()=>[a(f,{src:"/src/assets/img/upgrade-box-level"+(S+e.storeConnect.valueUpgrades[k])+".png","preview-disabled":"","intersection-observer-options":{root:"#image-scroll-container"}},null,8,["src"])]),_:2},1032,["value"])]),default:o(()=>[z(" "+X(e.storeConnect.selectBordered[k]?e.storeConnect.boxName[S+e.storeConnect.valueUpgrades[k]]:""),1)]),_:2},1032,["bordered","onClick"])]),_:2},1024))),128))]),_:1}))]),_:1})):($(),N(r,{key:2,class:"content-card"},{default:o(()=>[a(c,{class:"grid-center","x-gap":30,"y-gap":30,cols:"1",responsive:"screen",style:{"align-items":"center","text-align":"center"}},{default:o(()=>[a(m,null,{default:o(()=>[a(y,{description:"NO UPGRADABLE BOXES IN YOUR WALLET"},{extra:o(()=>[a(p,{type:"warning",onClick:s[0]||(s[0]=S=>e.$router.push("/home/faq"))},{default:o(()=>[z("READ FAQs TO LEARN MORE")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})):($(),N(r,{key:0,class:"content-card"},{default:o(()=>[a(c,{class:"grid-center","x-gap":0,"y-gap":12,cols:"8 xs:3 s:3 m:8 l:8",responsive:"screen",style:{"align-items":"center"}},{default:o(()=>[a(m,{span:"3 m:0"},{default:o(()=>[a(r,{style:{"text-align":"center"}},{default:o(()=>[an]),_:1}),a(r,{style:{"text-align":"center"}},{cover:o(()=>[a(f,{src:"/src/assets/img/upgrade-enigmatic-box.png","preview-disabled":"",alt:"Enigmatic Box"})]),_:1})]),_:1}),a(m,{span:"3"},{default:o(()=>[a(r,null,{default:o(()=>[rn,ln]),_:1})]),_:1}),a(m,{span:"0 m:2"},{default:o(()=>[a(r,{style:{"text-align":"center"}},{cover:o(()=>[a(f,{src:"/src/assets/img/upgrade-enigmatic-box.png","preview-disabled":"",alt:"Enigmatic Box"})]),_:1})]),_:1}),a(m,{span:"3"},{default:o(()=>[a(r,{style:$e(e.isMobile||e.isTablet?"":"text-align:right")},{default:o(()=>[a(i,{vertical:"",size:17},{default:o(()=>[a(p,{type:"secondary",tag:"a",href:"https://opensea.io/collection/onchainbirds",target:"_blank",style:{"--n-padding":"0 12px"}},{default:o(()=>[z("NESTED/STAKED BIRD")]),_:1}),a(p,{type:"secondary"},{default:o(()=>[z("BOX (CLAIM 1 OR LEVEL 1-4)")]),_:1})]),_:1})]),_:1},8,["style"])]),_:1})]),_:1})]),_:1}))]),e.storeConnect.selectedAccount?($(),N(x,{key:1,class:"footer footer--centered"},{default:o(()=>[C("div",un,[a(c,{"x-gap":24,"y-gap":12,cols:"3 xs:1 s:1 m:3 l:3",responsive:"screen"},{default:o(()=>[a(m,{style:{"text-align":"left"}},{default:o(()=>[a(p,{block:"",type:"secondary",class:"button-info"},{default:o(()=>[z(X(e.storeConnect.upgradesAvailable)+"x UPGRADES AVAILABLE",1)]),_:1})]),_:1}),a(m,null,{default:o(()=>[a(i,{justify:"center"},{default:o(()=>[a(p,{type:"primary",onClick:e.storeConnect.handlePlusButtonClick,disabled:e.storeConnect.upgradeTxSending},{icon:o(()=>[a(L,null,{default:o(()=>[mn]),_:1})]),default:o(()=>[z("ADD LEVEL ")]),_:1},8,["onClick","disabled"]),a(p,{type:"primary",onClick:e.storeConnect.handleMinusButtonClick,disabled:e.storeConnect.upgradeTxSending},{icon:o(()=>[a(L,null,{default:o(()=>[fn]),_:1})]),default:o(()=>[z("REMOVE LEVEL ")]),_:1},8,["onClick","disabled"])]),_:1})]),_:1}),a(m,null,{default:o(()=>[a(p,{block:"",type:"warning",onClick:e.storeConnect.upgradeSelection,disabled:e.storeConnect.upgradeTxSending},{default:o(()=>[z("UPGRADE SELECTION")]),_:1},8,["onClick","disabled"])]),_:1})]),_:1})])]),_:1})):($(),N(x,{key:0,class:"footer footer--centered"},{default:o(()=>[C("div",dn,[a(c,{"x-gap":24,"y-gap":12,cols:"3 xs:1 s:1 m:3 l:3",responsive:"screen"},{default:o(()=>[a(m,{style:{"text-align":"left"}},{default:o(()=>[a(p,{block:!!(e.isMobile||e.isTablet),type:"warning",onClick:s[1]||(s[1]=S=>e.$router.push("/home/faq"))},{default:o(()=>[z("READ FAQs TO LEARN MORE")]),_:1},8,["block"])]),_:1}),a(m),a(m)]),_:1})])]),_:1}))],64)}const yn=ge(on,[["render",pn]]);export{yn as default};
